...
//  * ---------------------------------------------------------------------
//  */
// import { ASSERT_EQ, ASSERT_TRUE, EXPECT_STREQ, EXPECT_THROW, TEST } from "../test_base";

// import { Dimensions, Network, RegionImplFactory } from "../../../typings/index";
...
// 	EXPECT_STREQ("bottomUpIn", in1.getName());
// 	EXPECT_STREQ("bottomUpIn", in2.getName());
// 	in1.setName("uselessName");
// 	EXPECT_STREQ("uselessName", in1.getName());
...
// 	// test getLinks()
// 	const links = in2.getLinks();
// 	ASSERT_EQ(1, links.length);
// 	for (const link of links) {
// 		// do something to make sure l[i] is a valid Link*
// 		ASSERT_TRUE(link != null);
// 		// should fail because regions are initialized
// 		EXPECT_THROW(() => in2.removeLink(link), "exception");
// 	}

// 	// test findLink()
// 	const l1 = in1.findLink("region1", "bottomUpOut");
// 	ASSERT_TRUE(l1 == null);
// 	const l2 = in2.findLink("region1", "bottomUpOut");
// 	ASSERT_TRUE(l2 != null);
...
// 		EXPECT_THROW(() => in2.removeLink(l2), "exception");
// 		// can't remove region b/c region1 has links
// 		EXPECT_THROW(() => net.removeRegion("region1"), "exception");
// 		region1.uninitialize();
// 		region2.uninitialize();
// 		EXPECT_THROW(() => in1.removeLink(l2), "exception");
// 		in2.removeLink(l2);
// 		EXPECT_THROW(() => in2.removeLink(l2), "exception");
// 		// l1 == NULL
// 		EXPECT_THROW(() => in1.removeLink(l1), "exception");
// 	}
// });
...
// 	const net = new Network();
// 	const region1 = net.addRegion("region1", "MyTestNode", "");
// 	const region2 = net.addRegion("region2", "TestNode", "");
...
// 	{
// 		const ai2 = in2.getData();
// 		const idata = (ai2.getBuffer());
// 		for (let i = 0; i < 64; i++) {
// 			idata[i] = 1;
// 		}
// 	}
...
// 	const net = new Network();
// 	let region1 = net.addRegion("region1", "MyTestNode", "");
// 	let region2 = net.addRegion("region2", "TestNode", "");
...
// 	const in1 = region1.getInput("bottomUpIn");
// 	let in2 = region2.getInput("bottomUpIn");
// 	const out1 = region1.getOutput("bottomUpOut");
...
// //   // Execute a command
// // std.string executeCommand(const Array<std.string>& args, Int64 index) override
// // {
// //     return "";
// //   }
...
// //     UInt64 *baseOutputBuffer = outputArray.getBuffer();

// //     Array<UInt64> ffInput;
// //     feedForwardIn_.getInputForNode(0, ffInput);
// //     NTA_CHECK(ffInput.length > 1);

// //     NTA_DEBUG << getName() << ".compute: ffInput size=" << ffInput.length
// //               << "; inputValue=" << ffInput[0];

// //     Array<UInt64> latInput;
// //     lateralIn_.getInputForNode(0, latInput);
// //     NTA_CHECK(latInput.length > 1);

// //     NTA_DEBUG << getName() << ".compute: latInput size=" << latInput.length
...
// //     Array<UInt64> nodeInput;
// //     feedbackIn_.getInputForNode(0, nodeInput);
// //     NTA_CHECK(nodeInput.length >= 1);

// //     NTA_DEBUG << getName() << ".compute: fbInput size=" << nodeInput.length
...
// 	const r1 = net.addRegion("R1", "L4TestRegion", "{\"k\": 1}");
// 	const r2 = net.addRegion("R2", "L4TestRegion", "{\"k\": 5}");
...
// 	const r3 = net.addRegion("R3", "L2TestRegion", "");
// 	const r4 = net.addRegion("R4", "L2TestRegion", "");
...
// 	const r1OutBuf = (r1.getOutput("out").getData().getBuffer());
// 	const r2OutBuf = (r2.getOutput("out").getData().getBuffer());
// 	const r3OutBuf = (r3.getOutput("out").getData().getBuffer());
// 	const r4OutBuf = (r4.getOutput("out").getData().getBuffer());

// 	/* ITERATION #1 */
// 	net.run(1);

// 	// Validate R1
// 	ASSERT_EQ(0, r1OutBuf[1]); // feedbackIn from R3; delay=1
// 	ASSERT_EQ(1, r1OutBuf[0]); // out (1 + feedbackIn)

// 	// Validate R2
// 	ASSERT_EQ(0, r2OutBuf[1]); // feedbackIn from R4; delay=1
// 	ASSERT_EQ(5, r2OutBuf[0]); // out (5 + feedbackIn)

// 	// Validate R3
// 	ASSERT_EQ(1, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(0, r3OutBuf[2]); // lateralIn from R4; delay=1
// 	ASSERT_EQ(1, r3OutBuf[0]); // out (feedForwardIn + lateralIn)

// 	// Validate R4
// 	ASSERT_EQ(5, r4OutBuf[1]); // feedForwardIn from R2; delay=0
// 	ASSERT_EQ(0, r4OutBuf[2]); // lateralIn from R3; delay=1
// 	ASSERT_EQ(5, r4OutBuf[0]); // out (feedForwardIn + lateralIn)

// 	/* ITERATION #2 */
// 	net.run(1);

// 	// Validate R1
// 	ASSERT_EQ(1, r1OutBuf[1]); // feedbackIn from R3; delay=1
// 	ASSERT_EQ(2, r1OutBuf[0]); // out (1 + feedbackIn)

// 	// Validate R2
// 	ASSERT_EQ(5, r2OutBuf[1]);  // feedbackIn from R4; delay=1
// 	ASSERT_EQ(10, r2OutBuf[0]); // out (5 + feedbackIn)

// 	// Validate R3
// 	ASSERT_EQ(2, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(5, r3OutBuf[2]); // lateralIn from R4; delay=1
// 	ASSERT_EQ(7, r3OutBuf[0]); // out (feedForwardIn + lateralIn)

// 	// Validate R4
// 	ASSERT_EQ(10, r4OutBuf[1]); // feedForwardIn from R2; delay=0
// 	ASSERT_EQ(1, r4OutBuf[2]);  // lateralIn from R3; delay=1
// 	ASSERT_EQ(11, r4OutBuf[0]); // out (feedForwardIn + lateralIn)

// 	/* ITERATION #3 */
// 	net.run(1);

// 	// Validate R1
// 	ASSERT_EQ(7, r1OutBuf[1]); // feedbackIn from R3; delay=1
// 	ASSERT_EQ(8, r1OutBuf[0]); // out (1 + feedbackIn)

// 	// Validate R2
// 	ASSERT_EQ(11, r2OutBuf[1]); // feedbackIn from R4; delay=1
// 	ASSERT_EQ(16, r2OutBuf[0]); // out (5 + feedbackIn)

// 	// Validate R3
// 	ASSERT_EQ(8, r3OutBuf[1]);  // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(11, r3OutBuf[2]); // lateralIn from R4; delay=1
// 	ASSERT_EQ(19, r3OutBuf[0]); // out (feedForwardIn + lateralIn)

// 	// Validate R4
// 	ASSERT_EQ(16, r4OutBuf[1]); // feedForwardIn from R2; delay=0
// 	ASSERT_EQ(7, r4OutBuf[2]);  // lateralIn from R3; delay=1
// 	ASSERT_EQ(23, r4OutBuf[0]); // out (feedForwardIn + lateralIn)
// });
...
// 	// Validate R3
// 	ASSERT_EQ(1, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(0, r3OutBuf[2]); // lateralIn loopback from R3; delay=1
// 	ASSERT_EQ(1, r3OutBuf[0]); // out (feedForwardIn + lateralIn)
...
// 	ASSERT_EQ(0, r1OutBuf[1]); // feedbackIn
// 	ASSERT_EQ(1, r1OutBuf[0]); // out

// 	// Validate R3
// 	ASSERT_EQ(1, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(1, r3OutBuf[2]); // lateralIn loopback from R3; delay=1
// 	ASSERT_EQ(2, r3OutBuf[0]); // out (feedForwardIn + lateralIn)
...
// 	// Validate R3
// 	ASSERT_EQ(1, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(2, r3OutBuf[2]); // lateralIn loopback from R3; delay=1
// 	ASSERT_EQ(3, r3OutBuf[0]); // out (feedForwardIn + lateralIn)
...
// 	// Validate R1
// 	ASSERT_EQ(3, r1OutBuf[1]); // feedbackIn from R3; delay=1
// 	ASSERT_EQ(4, r1OutBuf[0]); // out (1 + feedbackIn)

// 	// Validate R3
// 	ASSERT_EQ(4, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(3, r3OutBuf[2]); // lateralIn loopback from R3; delay=1
// 	ASSERT_EQ(7, r3OutBuf[0]); // out (feedForwardIn + lateralIn)
...
// 	// Validate R3
// 	ASSERT_EQ(8, r3OutBuf[1]); // feedForwardIn from R1; delay=0
// 	ASSERT_EQ(7, r3OutBuf[2]); // lateralIn loopback from R3; delay=1
// 	ASSERT_EQ(15, r3OutBuf[0]); // out (feedForwardIn + lateralIn)
...
// 	// Validate R1
// 	ASSERT_EQ(2, r1OutBuf[1]); // feedbackIn from R3; delay=1
// 	ASSERT_EQ(3, r1OutBuf[0]); // out (1 + feedbackIn)
// });
