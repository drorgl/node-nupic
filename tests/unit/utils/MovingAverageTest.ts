...
TEST("MovingAverage", "Instance",()=>
{
  ...
  {
    Array<Real32> expectedWindow = [3.0];
    m.compute(3);
  ...
  {
    Array<Real32> expectedWindow = {3.0, 4.0};
    m.compute(4);
    newAverage = m.getCurrentAvg();
  ...
  {
    Array<Real32> expectedWindow = {3.0, 4.0, 5.0};
    m.compute(5);
    newAverage = m.getCurrentAvg();
  ...
  {
    Array<Real32> expectedWindow = {4.0, 5.0, 6.0};
    m.compute(6);
    newAverage = m.getCurrentAvg();
