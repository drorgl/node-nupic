...
// import { NTA_BasicType, uint, int, bool } from "../../../typings/index";
// /** @file
...
// class ArrayTestParameters {
// 	public dataType: NTA_BasicType;
// 	public dataTypeSize: uint;
// 	public allocationSize: int; //We intentionally use an int instead of a size_t for
...
// 	public testUsesInvalidParameters: bool;

// 	// constructor() {
// 	//   //this.dataType = NTA_BasicType -1;
...
// 	constructor(
// 		dataTypeParam: NTA_BasicType,
// 		dataTypeSizeParam: uint,
// 		allocationSizeParam: int,
// 		dataTypeTextParam: string,
// 		testUsesInvalidParametersParam: bool) {
// 		this.dataType = (dataTypeParam);
// 		this.dataTypeSize = (dataTypeSizeParam);
// 		this.allocationSize = (allocationSizeParam);
// 		this.dataTypeText = (dataTypeTextParam);
// 		this.testUsesInvalidParameters = (testUsesInvalidParametersParam);
// 	}
// };

// class ArrayTest //: public ::testing::Test
// {
// 	//std::map<string,ArrayTestParameters> testCases_;
// 	private testCases_: { [case_name: string] : ArrayTestParameters; } = {};

// 	//typedef std::map<string,ArrayTestParameters>::iterator
// 	//  TestCaseIterator;

// 	setupArrayTests(): void {
...
// 		this.testCases_.clear();
// 		this.testCases_["NTA_BasicType_Byte"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Byte, 1, 10, "Byte", false);
// 		this.testCases_["NTA_BasicType_Int16"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Int16, 2, 10, "Int16", false);
// 		this.testCases_["NTA_BasicType_UInt16"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_UInt16, 2, 10, "UInt16", false);
// 		this.testCases_["NTA_BasicType_Int32"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Int32, 4, 10, "Int32", false);
// 		this.testCases_["NTA_BasicType_UInt32"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_UInt32, 4, 10, "UInt32", false);
// 		this.testCases_["NTA_BasicType_Int64"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Int64, 8, 10, "Int64", false);
// 		this.testCases_["NTA_BasicType_UInt64"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_UInt64, 8, 10, "UInt64", false);
// 		this.testCases_["NTA_BasicType_Real32"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Real32, 4, 10, "Real32", false);
// 		this.testCases_["NTA_BasicType_Real64"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Real64, 8, 10, "Real64", false);
// 		this.testCases_["NTA_BasicType_Bool"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Bool, 1, 10, "Bool", false);
// 		//#ifdef NTA_DOUBLE_PRECISION
// 		this.testCases_["NTA_BasicType_Real"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Real, 8, 10, "Real64", false);
// 		//#else
// 		this.testCases_["NTA_BasicType_Real"] =
// 			new ArrayTestParameters(NTA_BasicType.NTA_BasicType_Real, 4, 10, "Real32", false);
// 		//#endif
// 		this.testCases_["Non-existent NTA_BasicType"] =
// 			new ArrayTestParameters(- 1, 0, 10, "N/A", true);
...
// function AccessViolationHandler(signal: int): void {
// 	throw new AccessViolationError();
// }

// type AccessViolationHandlerPointer = (x: int) => void;
...
// 		string; name(BasicType: : getName(a.getType()));
