#include "UniformLinkPolicy.hpp"

namespace node_nupic {
	namespace engine {
		void UniformLinkPolicy::Init(v8::Handle<v8::Object> target, std::shared_ptr<namespace_wrap> overload) {
		}
	}
...
//
//import { Coordinate, Dimensions } from "../ntypes/Dimensions";
//import {Fraction} from "../types/Fraction";
//import { bool, pair, size_t } from "../types/Types";
//import { SplitterMap } from "./Input";
...
//}
//
//export interface UniformLinkPolicy extends LinkPolicy {
//	// ---
...
//	setNodeOutputElementCount(elementCount: size_t): void;
...
//	//     vector<Real64> rfSize_;
//	//     vector<Real64> rfOverlap_;
//	//     GranularityType rfGranularity_;
//	//     vector<Real64> overhang_;
//	//     vector<OverhangType> overhangType_;
//	//     vector<Real64> span_;
//	//     bool strict_;
//
//	//     template <typename T>
//	//     struct DefaultValuedVector : public vector<T>
//	//     {
...
//	//     // ---
//	getInputBoundsForNode(
//		nodeIndex: size_t,
//		dimension: size_t): pair<Fraction, Fraction>;
//
//	getInputBoundsForNode(
...
//	//            vector<size_t>& input,
//	//            vector<pair<Fraction,Fraction> > orthotopeBounds,
//	//            vector<Fraction>& subCoordinate) const;
//
//	//     // ---
...
//} // UniformLinkPolicy
//export let UniformLinkPolicy: UniformLinkPolicy_Static = nupic_module.x;
//// } // namespace nupic
//
