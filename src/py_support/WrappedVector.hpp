#ifndef _NUPIC_PYSUPPORT_WRAPPEDVECTOR_H_
#define _NUPIC_PYSUPPORT_WRAPPEDVECTOR_H_

//#include "nupic/py_support/WrappedVector.hpp"

#include "../nupic.h"

namespace node_nupic {
	namespace py_support {
		class WrappedVector : public overres::ObjectWrap {
		public:
