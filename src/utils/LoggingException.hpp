#ifndef _NUPIC_UTILS_LOGGINGEXCEPTION_H_
#define _NUPIC_UTILS_LOGGINGEXCEPTION_H_
...
class LoggingException : public overres::ObjectWrap {
public:
...
//   {
//     constructor( filename : string,  lineno : number) :
//       Error(filename, lineno, std::string()), ss_ (std::string()),
